...
// Remember "languages" folder in assets.
...
export const LanguageProvider = ({ children }) => {
  ...
  // Si existe localStoragge lleno las variables defaultLocale y defaultMessages, sino
  // estas recibiran su correspondiente valor de acuerdo con el idioma del Sistema Operativo.
  if (langFromStorage) {
    ...
    if (langFromStorage === 'en-US') {
      ...
      // If the localStorage doesn't have "en-US" and it "es-ES" either.
      defaultLocale = 'en-US'
      defaultMessages = EnglishMessages
    }
  } else {
